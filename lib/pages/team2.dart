...
import 'package:xuberance2022_website/pages/school.dart';
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: Container(
                                ...
                                decoration: const BoxDecoration(
                                  image: DecorationImage(
                                    image: AssetImage("images/JOEETA_BASU.png"),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                              ),
                            ...
                            ClipRRect(
                              ...
                              child: Container(
                                ...
                                decoration: const BoxDecoration(
                                  image: DecorationImage(
                                    image:
                                        AssetImage("images/SOMNATH_DHAR.png"),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                              ),
...
PS: if you can't find him, he's probably thoughting about being in SRCC""",
                            link: "images/SHUBHAM_KOTHARI.png"),
                        ImgRtr(
...
""",
                            link: "images/RIDDHAM_KR_AGARWAL.png"),
                        ImgRtr(
                            name: "DHRUV  RAMPURIA",
                            designation: "CONVENER",
                            about: """
...
PS: If you can't find him, he's probably reviewing some documents (for the third time).""",
                            link: "images/DHRUV_RAMPURIA.png"), //
                      ],
                    ),
...
""",
                            link: "images/KRISH_MURJCHANDANDANI.png"),
                        ImgRtr(
                            name: "MADHAV  SHAH",
                            designation: "SECRETARY",
                            about: """ 
...
""",
                            link: "images/HARSH_CHITLANGIA.png"),
                        ImgRtr(
                            name: "ARYAN  JAIN",
                            designation: "DIRECTOR",
                            about: """
...
""",
                            link: "images/ARYAN_JAIN.png"),
                        ImgRtr(
                            name: "AYUSH NARNOLIA",
                            designation: "DIRECTOR",
                            about: """The prince of Jamtara, presenting to you our director, Ayush Narnolia. His skills are commendable, from bringing in the most annoying sponsors to making friends with almost everyone in the core. Known to be awake for 24 hrs a day ( sober for only 10), he will always pick up your call without fail. He has a passion for basketball (though his habits suggest otherwise). 
PS: if you cannot find him, he is probably high, (he'll still pick up your call). """,
                            link: "images/2.png"),
                      ],
                    ),
                    SizedBox(height: height * .1),
...
""",
                            link: "images/VEDANT_KEJARIWAL.png"),
                        ImgRtr(
...
""",
                            link: "images/HITANSH_AGARWAL.png"),
                        ImgRtr(
                            name: "SHAURYA BERIWALA",
                            designation: "TECHNICAL  DIRECTOR",
                            about: """Shaurya beriwala the golu of st xaviers collegiate school class 12 quite decent with all the blabbering about stuff he doesn’t even know about and hardly can pronounce anything properly good with his books and just one sport “badminton” even though he loses all the time in it wears school pants with his kurta instead of pajama and has enough guts to bunk 20 days of school in one semester""",
                            link: "images/3.png"),
                      ],
                    ),
                    SizedBox(height: height * .1),
...
""",
                            link: "images/HARSH_VARDHAN_KASAT.png"),
                        ImgRtr(
...
PS: if you can’t find him, he is probably at some house party.""",
                            link: "images/ADITYA_SHREEDHARAN.png"),
                        ImgRtr(
                            name: "ARPIT JAIN",
                            designation: "TREASURER",
                            about: """If social awkwardness was a person, it would be none other than our co-treasurer Arpit Jain. He has a 6th sense for sensing people within a 1 mile radius, if it's someone his age (especially girls), he steers clear from them but when it comes to potential sponsors and event companies, it proves to be quite useful. From raging in video games to constantly using his phone to avoid talking, Arpit is a huge introvert with a gift of good height. 
PS: if you can't find him it's probably because he doesn't want you too.""",
                            link: "images/1.png"),
                      ],
                    ),
                    SizedBox(height: height * .1),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Department3(
                          dep: "SECURITY",
                          name1: "Nikunjj Saraf",
                          name2: "Ansh  Binani", name3: "Vinayak  Puri",),
                        Department(
                            dep: "TRANSPORT",
                        ...
                        Department(
                            dep: "LOGISTICS",
                            name1: "Vihaan Vardhan Agarwal",
                            name2: "Yash Chandak"),
                        Department(
                            dep: "SCHOOL-IN-CHARGE",
                            name1: "Rishabh Mookerjee",
                            name2: "Varenya Kanoria"),
                         Department3(
                            dep:"PHOTOGRAPHY", name1: "Nirupam Biswas", name2: "Siddhant Kashyap", name3: "Dhruv Bajesaria")
...
class Department2 extends StatefulWidget {
  final String dep;
  final String name1;
  ...
  @override
  // ignore: no_logic_in_create_state
  State<Department2> createState() => _Department2State(
        dep: dep,
        name1: name1,
      );
}

class _Department2State extends State<Department2> {
  String dep;
  String name1;
...
class Department3 extends StatefulWidget {
  final String dep;
  final String name1;
  final String name2;
  final String name3;
  ...
  @override
  // ignore: no_logic_in_create_state
  State<Department3> createState() =>
      _Department3State(dep: dep, name1: name1, name2: name2, name3: name3);
}

class _Department3State extends State<Department3> {
  String dep;
  String name1;
  String name2;
  String name3;
