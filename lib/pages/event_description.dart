...
class Eventss extends StatefulWidget {
  ...
  Eventss({Key? key, required this.name,required this.about,
    ...
    required this.rules, required this.link,required this.floor
    // required this.event_head_1,required this.event_head_2,required this.event_head_3,required this.event_head_4,
  }) : super(key: key);
  ...
  State<Eventss> createState() => _EventssState(
    ...
    link: link,
    floor: floor,
    //event_head_1: event_head_1,
    //      event_head_2: event_head_2,
    //      event_head_3: event_head_3,
    //      event_head_4: event_head_4,
  );
}
                  ...
                  ElevatedButton(
                      onPressed: () {
                        Navigator.push(context,
                            MaterialPageRoute(builder: (context) => Location(name: name, des: about, mapLink: link, loc: location,floor: floor)));
                      },
