...
class _Events3State extends State<Events3> {
  ...
  Future<void> navigateToDescriptionlast(context) async {
    ...
    Navigator.push(
        context,
        PageTransition(
          child: Eventss(name: "X-VOGUE", about: "FASHION SHOW", category: "ON-STAGE", location: "Gymnasium", day: "1", time: "4:30", participants: "8 + 2", phrase:"Make the stage your world, Make the world your Runway.",
            rules: """
1.  Participants 8+2+2 (including backstage)

2.  Duration 6+2

3.  All the tracks to be played will have to be sent to the

4.  Fest’s official email address a week before the fest.

5.  Themes to be declared in the representatives meet.

6.  Rules are subject to change.

7.  All attire and apparels must follow norms of decency.

8.  Judging criteria: relevance to theme, coordination, rampwalk, vibrancy.
""",
            link: "images_des/X-VOGUE", floor: "",
            //event_head_1 : "",
            //             event_head_2 : "",
            //             event_head_3 : "",
            //             event_head_4 : "",
