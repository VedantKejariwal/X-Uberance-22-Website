                          ...
                          child: InkWell(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  PageTransition(
                                    child: Eventss(name: "X-SPIKE", about:"VOLLEYBALL", category: "SPORTING", location: "Back Field", day: "3", time: "8:30", participants: "6 + 3", phrase: "Can’t let the ball bounce.",
                                        rules: """
...
""",
                        ...
                        SizedBox(width: 0.01 * width, height: 30),
                        ClipRRect(
                          borderRadius: BorderRadius.circular(20.0),
                          child: InkWell(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  PageTransition(
                                    child: Eventss(name: "X-0OΔ", about: "FIFA", category: "SPORTING", location: "AV Room", day: "2", time: "9:00", participants: "1 + 1", phrase:"EA SPORTS IT'S IN THE GAME!",
                                        rules: """
