...
List Sporting1 = ["X-GOAL", "X-HOOP", "X-PONG", "X-PULL", "X-MATE", "X-WICKET"];
List Offstage1 = [
  "X-QUIZITE",
  "X-GAANA",
  "X-SPLASH",
...
""",
  ...
  Eventss(
    ...
    time: "12:30",
    participants: "5 + 5",
    phrase: "Dunk like Lebron, Shoot like Larry.",
    rules: """
...
""",
  ...
  Eventss(
      ...
      time: "1:00",
      participants: "4",
      phrase: "A table where you actually play.",
      rules: """
...
""",
  ...
  Eventss(
      ...
      time: "8:30",
      participants: "2",
      phrase: "Another battle between the colours.",
      rules: """ 
...
""",
  ...
  Eventss(
      ...
      time: "9:00",
      participants: "1 + 1",
      phrase: "The EARTH without ART is “EH”!!",
      rules: """
1. Participants: 1+1
...
""",
  ...
  Eventss(
      ...
      time: "2:00",
      participants: "2",
      phrase: "When losing the case, find a loophole.",
      rules: """
1. Participants: 2
...
""",
  ...
  Eventss(
      ...
      time: "8:30",
      participants: "3",
      phrase: "Don't raise your voice, raise your stance.",
      rules: """
...
""",
      link: "images_des/X-MONTAGE"),
  Eventss(
      name: "X-BET",
      about: "REPRESENTATIVE EVENTS",
      category: "OFF-STAGE",
      location: "Online",
      day: "Pre-Fest",
      time: "",
      participants: "2",
      phrase: "Don't play the odds, play the man.",
      rules: """
...
List<Eventss> OnStage = [
  Eventss(
      ...
      time: "8:30",
      participants: "1",
      phrase: "Race against the clock. A minute is all you have got.",
      rules: """
1. No. of participants : 1 
...
""",
  ...
  Eventss(
      ...
      time: "12:30",
      participants: "4 + 2",
      phrase: "Directing and acting can enrich our history and culture.",
      rules: """
...
""",
  ...
  Eventss(
      ...
      time: "9:00",
      participants: "5 + 2",
      phrase: "Kya aapke toothpaste mein namak hai?!",
      rules: """
...
""",
      link: "images_des/X-ACT"),
  Eventss(
      name: "X-DROP",
      about: "RAP BATTTLE & BEATBOXING",
      category: "ON-STAGE",
      location: "Soumitra Sadan",
      day: "1",
      time: "1:30",
      participants: "1 + 1",
...
""",
      link: "images_des/X-RAGA"),
  Eventss(
      name: "X-HOP",
      about: "DANCE FACE OFF",
      category: "ON-STAGE",
      location: "Gymnasium Podium",
      day: "1",
      time: "12:30",
      participants: "1 + 1",
...
""",
  ...
  Eventss(
      ...
      time: "10:00",
      participants: "1",
      phrase: "Scuse me! Brudda? Brudda idhar",
      rules: """ 
...
""",
  ...
  Eventss(
      ...
      time: "4:30",
      participants: "8 + 2",
      phrase: "Make the stage your world, Make the world your Runway.",
      rules: """
