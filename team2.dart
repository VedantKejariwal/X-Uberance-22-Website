            ...
            children: [
              ...
              Row(
                ...
                children:[
                  ...
                  ImgRtr(name: "MRS. JOEETA BASU", designation: "TEACHER-IN-CHARGE", about: "______", link: "assets/background.png"),
                  ImgRtr(name: "MR. SOMNATH DHAR", designation: "TEACHER-IN-CHARGE", about: "______", link: "assets/background.png"),
                  SizedBox(height:0.1, width:width*0.2),
                ],
              ),
              const Divider(
              ...
              Row(
                ...
                children:[
                  ...
                  ImgRtr(name: "AARAV  MODI", designation: "PUBLIC  RELATIONS  OFFICER",
                      about: """The student to whom everyone runs to for help in maths or science. His life is just as hard as anyone else's except for the fact that he has a house for every mood. Already set to enter into the major leagues of research in various fields, he still has the dream of playing cricket left.

We hope he is set to manage X-Uberance just as he is set on going to the USA and then returning to India for reasons unknown.
So don't be surprised to hear his name chant in the middle of the fest for no reason… just join in😉
...
""",
              ...
              Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children:[
                    Text("Click on the images to know more !",
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 15,
                        fontFamily: 'Xavier2',
              ...
              Column(
                ...
                children: [
                  ...
                  Department(dep: "SECURITY", name1: "Arpit  Jain", name2: "Vinayak  Puri"),
                  Department(dep: "TRANSPORT", name1: "Rajvir Singh Sachar", name2: "Harshit  Singhania"),
                  Department(dep: "HOSPITALITY", name1: " Md. Zayed Khan", name2: "Mayank  Malhotra"),
                  Department(dep: "SCHOOL-IN-CHARGE", name1: "Rishabh Mukherjee", name2: "Varenya Kanoria"),
                  Department(dep: "LOGISTICS", name1: "Rishabh Mukherjee", name2: ""),
                ],
              ),
              const Divider(
                color: Colors.white,
...
class Department extends StatefulWidget {
  ...
  String name1;
  String name2;
  Department({Key? key, required this.dep, required this.name1, required this.name2}) : super(key: key);

  @override
  State<Department> createState() => _DepartmentState(dep: dep, name1: name1, name2: name2);
}
...
class _DepartmentState extends State<Department> {
  ...
  String name1;
  String name2;
  _DepartmentState({required this.dep, required this.name1, required this.name2});
  @override
  Widget build(BuildContext context) {
    return Center(
      child: Column(
